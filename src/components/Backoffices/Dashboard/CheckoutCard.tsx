...
const CheckoutCard = () => {
  ...
  return (
    <div>
        <Card icon={<IoMdExit />} bgClass={'bg-red-300'} title={`Total Checkout`} value={Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(totalCheckout)} borderLeft={true} />
    </div>
  )
}
